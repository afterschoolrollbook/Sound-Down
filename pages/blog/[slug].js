    ...
    <>
      <Head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          author: { '@type': 'Organization', name: 'Sound-Down' },
          publisher: { '@type': 'Organization', name: 'Sound-Down', url: 'https://www.sound-down.com' },
        })}} />
      </Head>
        ...
        <article style={{ maxWidth: 720 }}>
          ...
          <div className="cta-box">
            <p style={{ fontWeight: 700, fontSize: 16, marginBottom: 8 }}>
              {lang === 'ko' ? '지금 바로 효과음을 다운로드하세요!' : 'Download free sound effects now!'}
            </p>
            <Link href="/" className="cta-btn">
              {lang === 'ko' ? '🔊 Sound-Down 사용하기' : '🔊 Use Sound-Down'}
            </Link>
          </div>
        </article>
      </main>
      ...
      <footer className="footer">
        <div className="wrap">
          <p className="footer-text">© 2024 Sound-Down. CC0 무료 효과음 다운로드.</p>
