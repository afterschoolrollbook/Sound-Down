...
const META = {
  ko: {
    title: '블로그 | Sound-Down — 무료 효과음 팁',
    desc: 'CC0 효과음 활용법, 유튜브 사운드 가이드, 크리에이터 팁 등 유용한 정보를 제공합니다.',
    heading: '블로그',
    sub: '무료 효과음 & 크리에이터 팁',
    empty: '아직 글이 없어요.',
    readMore: '읽기 →',
  ...
  en: {
    title: 'Blog | Sound-Down — Free Sound Effects Tips',
    desc: 'Tips on CC0 sound effects, YouTube audio guides, and creator resources.',
    heading: 'Blog',
    sub: 'Free Sound Effects & Creator Tips',
    empty: 'No posts yet.',
    readMore: 'Read more →',
    langBtn: '🇰🇷 한국어',
